...
import { ArrowRight, Bell, Server, Database, Radio, Activity, Wifi, WifiOff, Gauge, Layers3, Cpu, Network, Brain, LineChart, CircuitBoard, Workflow, GitBranch, Clock3 } from "lucide-react";
import { p as pingBackend, A as API_BASE_URL, g as getToken } from "./router-D-aI0tZc.js";
import { e as enableBrowserPush } from "./push-notifications-kiOw6TiQ.js";
import { toast } from "sonner";
import "@tanstack/react-query";
const PENDING_PUSH_ENABLE_KEY = "scinetwork.enablePushAfterLogin";
const featureCards = [{
  title: "Device Inventory",
  desc: "Kelola Mikrotik, switch, router, server, dan endpoint dari satu dashboard terpusat.",
  icon: Server
}, {
  title: "Alerting & Notifikasi",
  desc: "Threshold untuk packet loss, latency, availability, HTTP status, dan kondisi perangkat.",
  icon: Bell
}, {
  title: "Manual Tools",
...
const technologyCards = [{
  ...
  desc: "React · TanStack Router · React Query · Tailwind CSS · Radix UI.",
  icon: Layers3,
  points: ["Routing halaman: landing, auth, dashboard, devices, alerts, logs, users, feedbacks, manual tools.", "Health check API langsung dari landing page agar status backend terlihat sebelum masuk dashboard.", "Tampilan gelap dengan network canvas untuk konteks visual sistem monitoring."]
}, {
  title: "Backend Monitoring Engine",
  desc: "Go Fiber sebagai REST API utama untuk autentikasi, inventory, alert, dan network tools.",
  icon: Cpu,
  points: ["Scheduler menjalankan ping, SNMP, HTTP probe, dan interface check secara berkala.", "Repository layer memisahkan akses data: users, devices, alerts, feedback, logs.", "Middleware auth menjaga endpoint dashboard aman sesuai sesi dan role pengguna."]
}, {
  title: "Data Layer",
  desc: "MySQL untuk data operasional, ClickHouse untuk log monitoring berukuran besar.",
  icon: Database,
  points: ["MySQL menyimpan akun, perangkat, konfigurasi monitoring, alert, dan feedback.", "ClickHouse untuk network_logs historis agar query time-series dan ML tetap cepat.", "Log probe: status, latency, packet loss, jitter, CPU, memory, bandwidth, HTTP status."]
}];
const pipelineSteps = [{
  title: "Collect",
  desc: "Go collector mengambil sinyal dari ping, SNMP, HTTP, dan interface check secara berkala.",
  icon: Network,
  emoji: "📡"
}, {
  title: "Store",
  desc: "Hasil monitoring disimpan sebagai network_logs untuk analisis historis dan audit perangkat.",
  icon: Database,
  emoji: "💾"
}, {
  title: "Train",
  desc: "Python trainer membaca ClickHouse, membuat fitur, lalu melatih Isolation Forest harian.",
  icon: Brain,
  emoji: "🧠"
}, {
  title: "Score",
  desc: "FastAPI sidecar memuat model terbaru dan memberi skor anomali untuk metric real-time dan batch.",
  icon: LineChart,
  emoji: "📊"
}];
const mlCards = [{
  ...
  icon: CircuitBoard,
  points: ["Numeric: success, duration, latency, packet_loss, jitter, response_time, CPU, memory, bandwidth.", "Derived: is_timeout, is_error_http, latency_missing, timeout_flag, hour_of_day, day_of_week.", "Action dan status sebagai fitur kategori agar model bisa membedakan tipe probe."]
}, {
  title: "Isolation Forest Pipeline",
  desc: "sklearn pipeline agar preprocessing dan detector konsisten saat training dan inference.",
  icon: Brain,
  points: ["Numeric imputer + StandardScaler untuk normalisasi skala metric.", "Categorical imputer + OneHotEncoder untuk action/status baru tanpa merusak inference.", "Isolation Forest mendeteksi pola jarang — latency, timeout, error jaringan."]
}, {
  title: "Real-Time Sidecar",
  desc: "Model diekspor harian lalu dilayani FastAPI untuk scoring dari sistem Go.",
  icon: Workflow,
  points: ["train_daily.sh menjalankan training berkala dengan DAYS, LIMIT, OUTPUT, MODELS_DIR.", "Model tersimpan sebagai model_YYYY-MM-DD.joblib dan pointer latest.", "Endpoint /score dan /score/batch mengembalikan is_anomaly, prediction, anomaly_score."]
}];
const roadmapItems = [{
  title: "Adaptive Threshold per Device",
  desc: "Baseline normal tiap perangkat bisa berbeda. Alert lebih akurat berdasarkan kebiasaan device.",
  tag: "ML",
  icon: Gauge
}, {
  title: "Anomaly Explanation",
  desc: "Dashboard menampilkan alasan anomali — latency naik, packet loss tinggi, atau traffic tak normal.",
  tag: "Explainability",
  icon: LineChart
}, {
  title: "Feedback Loop",
  desc: "Label admin — true anomaly atau false alarm — dipakai untuk evaluasi model dan tuning contamination.",
  tag: "Human-in-loop",
  icon: GitBranch
}, {
  title: "Forecasting Capacity",
  desc: "Data bandwidth, CPU, memory historis untuk prediksi kapasitas sebelum bottleneck terjadi.",
  tag: "Prediction",
  icon: Clock3
}, {
  title: "Root Cause Correlation",
  desc: "Alert dari beberapa device dikorelasikan dengan topology agar gangguan upstream cepat ditemukan.",
  tag: "Topology",
  icon: Network
}, {
  title: "Automated Response",
  desc: "Anomali kritis memicu runbook, notifikasi prioritas, eskalasi, atau integrasi ticketing otomatis.",
  tag: "Automation",
  icon: Bell
}];
const bigStats = [{
  num: "30d",
  label: "Training window historis"
}, {
  num: "4×",
  label: "Jenis probe monitoring"
}, {
  num: "v4.0",
  label: "Versi API terkini"
}];
const thinFeats = [{
...
const mockLogs = [{
  ...
  type: "ok",
  label: "✓ PING OK",
  msg: "core-router-01 · latency 2.1ms · loss 0%"
}, {
  time: "08:42:03",
  type: "ok",
  label: "✓ HTTP 200",
  msg: "api.internal · response 48ms · status OK"
}, {
  time: "08:42:05",
  type: "warn",
  label: "⚠ ANOMALY",
  msg: "switch-floor3 · latency spike 340ms · score −0.42"
}, {
  time: "08:42:07",
  type: "ok",
  label: "✓ SNMP OK",
  msg: "server-db-02 · CPU 34% · mem 67% · bw 120Mbps"
}];
...
function useNetworkCanvas(canvasRef) {
  useEffect(() => {
    ...
    function init() {
      const n = Math.min(70, Math.floor(canvas.width * canvas.height / 14e3));
      nodes = Array.from({
        length: n
      }, () => ({
      ...
      for (let i = 0; i < nodes.length; i++) {
        for (let j = i + 1; j < nodes.length; j++) {
          ...
          if (d < 150) {
            ...
            ctx.strokeStyle = `rgba(52,211,153,${0.18 * (1 - d / 150)})`;
            ctx.lineWidth = 0.6;
            ctx.stroke();
          }
        }
...
function useReveal() {
  useEffect(() => {
    const obs = new IntersectionObserver((entries) => entries.forEach((e) => {
      if (e.isIntersecting) {
        e.target.classList.add("scin-visible");
...
function StatusDot({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "scin-status-dot-row", style: {
    color
  }, children: [
    /* @__PURE__ */ jsx("span", { className: `scin-dot ${cls}` }),
    " ",
    status
  ] });
}
function StatusTile({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "scin-status-card", children: [
    /* @__PURE__ */ jsxs("div", { style: {
      display: "flex",
      alignItems: "center",
      justifyContent: "space-between"
    }, children: [
      /* @__PURE__ */ jsx("div", { className: "scin-status-label", children: card.label }),
      /* @__PURE__ */ jsx(Icon, { className: "h-4 w-4", style: {
        color: "var(--subtle)"
      } })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "scin-status-val", children: card.value }),
    /* @__PURE__ */ jsx(StatusDot, { status: card.status })
  ] });
}
function SectionHead({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "scin-section-head scin-reveal", children: [
    /* @__PURE__ */ jsx("div", { className: "scin-eyebrow", children: eyebrow }),
    /* @__PURE__ */ jsx("h2", { className: "scin-section-title", children: title }),
    /* @__PURE__ */ jsx("p", { className: "scin-section-desc", children: desc })
  ] });
}
function FeatCard({
  card
  ...
  const Icon = card.icon;
  return /* @__PURE__ */ jsxs("div", { className: "scin-feat-card scin-reveal", children: [
    /* @__PURE__ */ jsx("div", { className: "scin-feat-icon", children: /* @__PURE__ */ jsx(Icon, { className: "h-5 w-5", style: {
      color: "var(--green)"
    } }) }),
    /* @__PURE__ */ jsx("div", { className: "scin-feat-title", children: card.title }),
    /* @__PURE__ */ jsx("p", { className: "scin-feat-desc", children: card.desc })
  ] });
}
function DetailCardUI({
  card,
  delay = ""
}) {
  const Icon = card.icon;
  return /* @__PURE__ */ jsxs("div", { className: `scin-detail-card scin-reveal ${delay}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "scin-detail-head", children: [
      /* @__PURE__ */ jsx("div", { className: "scin-detail-icon", children: /* @__PURE__ */ jsx(Icon, { className: "h-5 w-5", style: {
        color: "var(--blue)"
      } }) }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "scin-detail-title", children: card.title }),
        /* @__PURE__ */ jsx("p", { className: "scin-detail-desc", children: card.desc })
      ] })
    ] }),
    /* @__PURE__ */ jsx("ul", { className: "scin-detail-points", children: card.points.map((p) => /* @__PURE__ */ jsx("li", { children: p }, p)) })
  ] });
}
function PipelineCard({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `scin-pipeline-card scin-reveal ${delay}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "scin-pipeline-num", children: [
      "STEP 0",
      pipelineSteps.indexOf(step) + 1
    ] }),
    /* @__PURE__ */ jsx("div", { className: "scin-pipeline-emoji", children: step.emoji }),
    /* @__PURE__ */ jsx("div", { className: "scin-pipeline-title", children: step.title }),
    /* @__PURE__ */ jsx("p", { className: "scin-pipeline-desc", children: step.desc })
  ] });
}
function RoadmapCard({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `scin-roadmap-card scin-reveal ${delay}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "scin-roadmap-top", children: [
      /* @__PURE__ */ jsx("span", { className: "scin-roadmap-tag", children: item.tag }),
      /* @__PURE__ */ jsx(Icon, { className: "h-5 w-5", style: {
        color: "var(--muted)"
      } })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "scin-roadmap-title", children: item.title }),
    /* @__PURE__ */ jsx("p", { className: "scin-roadmap-desc", children: item.desc })
  ] });
}
function MiniChart({
  vals,
  ...
  return /* @__PURE__ */ jsx("div", { className: "scin-bars", children: vals.map((v, i) => /* @__PURE__ */ jsx("div", { className: "scin-bar", style: {
    height: `${v / max * 100}%`,
    background: isAnomaly && v > 60 ? "linear-gradient(to top,#f87171,rgba(248,113,113,0.3))" : "linear-gradient(to top,#34d399,rgba(52,211,153,0.3))"
  } }, i)) });
}
function Landing() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "scin-root", children: [
    /* @__PURE__ */ jsx("canvas", { ref: canvasRef, className: "scin-canvas" }),
    /* @__PURE__ */ jsx("div", { className: "scin-glow-tl" }),
    /* @__PURE__ */ jsx("div", { className: "scin-glow-br" }),
    /* @__PURE__ */ jsxs("nav", { className: "scin-nav", children: [
      /* @__PURE__ */ jsxs("div", { className: "scin-nav-logo", children: [
        /* @__PURE__ */ jsx("div", { className: "scin-nav-icon", children: /* @__PURE__ */ jsx("img", { src: "/logo.png", alt: "SCINetwork logo", className: "scin-logo-img" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "scin-nav-name", children: "SCINetwork" }),
          /* @__PURE__ */ jsx("div", { className: "scin-nav-sub", children: "Go Fiber · MySQL · ML" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "scin-nav-links", children: [
        /* @__PURE__ */ jsx("a", { href: "#technology", className: "scin-nav-link", children: "Teknologi" }),
        /* @__PURE__ */ jsx("a", { href: "#machine-learning", className: "scin-nav-link", children: "Machine Learning" }),
        /* @__PURE__ */ jsx("a", { href: "#roadmap", className: "scin-nav-link", children: "Roadmap" }),
        /* @__PURE__ */ jsx(Link, { to: "/login", className: "scin-nav-link", children: "Login" }),
        /* @__PURE__ */ jsx(Link, { to: "/register", className: "scin-nav-link", children: "Register" }),
        /* @__PURE__ */ jsx(Link, { to: "/dashboard", className: "scin-nav-link scin-nav-cta", children: "Dashboard →" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("section", { className: "scin-hero", children: [
      /* @__PURE__ */ jsx("div", { className: "scin-orb scin-orb-1" }),
      /* @__PURE__ */ jsx("div", { className: "scin-orb scin-orb-2" }),
      /* @__PURE__ */ jsxs("div", { className: "scin-badge", children: [
        /* @__PURE__ */ jsx("span", { className: "scin-badge-dot" }),
        "API v4.0  ·  ML-Ready Observability"
      ] }),
      /* @__PURE__ */ jsx("h1", { className: "scin-h1", children: "SCINetwork" }),
      /* @__PURE__ */ jsx("div", { className: "scin-h1-sub", children: "Observability tanpa batas." }),
      /* @__PURE__ */ jsx("p", { className: "scin-hero-desc", children: "Dashboard monitoring jaringan yang menggabungkan inventory perangkat, real-time probing, time-series log, dan machine learning Isolation Forest — dalam satu platform terpadu." }),
      /* @__PURE__ */ jsxs("div", { className: "scin-hero-actions", children: [
        /* @__PURE__ */ jsxs(Link, { to: "/login", className: "scin-btn scin-btn-primary", children: [
          "Masuk ke Dashboard ",
          /* @__PURE__ */ jsx(ArrowRight, { size: 16 })
        ] }),
        /* @__PURE__ */ jsxs("button", { type: "button", className: "scin-btn scin-btn-secondary", onClick: onEnableLandingPush, disabled: pushBusy, children: [
          pushBusy ? "Menyiapkan Notifikasi..." : "Aktifkan Notifikasi",
          " ",
          /* @__PURE__ */ jsx(Bell, { size: 16 })
        ] }),
        /* @__PURE__ */ jsx("a", { href: "#technology", className: "scin-btn scin-btn-secondary", children: "Pelajari Lebih Lanjut" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "scin-hero-pills", children: ["Go Fiber API", "React Dashboard", "MySQL Config Store", "ClickHouse Logs", "FastAPI Sidecar", "Isolation Forest"].map((p) => /* @__PURE__ */ jsx("span", { className: "scin-pill", children: p }, p)) }),
      /* @__PURE__ */ jsxs("div", { className: "scin-mock", children: [
        /* @__PURE__ */ jsxs("div", { className: "scin-mock-bar", children: [
          /* @__PURE__ */ jsxs("div", { className: "scin-mock-dots", children: [
            /* @__PURE__ */ jsx("div", { className: "scin-mock-dot", style: {
              background: "#f87171"
            } }),
            /* @__PURE__ */ jsx("div", { className: "scin-mock-dot", style: {
              background: "#fbbf24"
          ...
          /* @__PURE__ */ jsx("span", { className: "scin-mock-title", children: "SCINetwork — Observability Dashboard · v4.0" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "scin-mock-body", children: [
          [{
            label: "SERVICE",
            val: "SCINetwork API",
            status: "online"
            ...
            val: API_BASE_URL,
            status: "online"
          }].map((c) => /* @__PURE__ */ jsxs("div", { className: "scin-mini", children: [
            /* @__PURE__ */ jsx("div", { className: "scin-mini-label", children: c.label }),
            /* @__PURE__ */ jsx("div", { className: "scin-mini-val", children: c.val }),
            /* @__PURE__ */ jsxs("div", { className: "scin-mini-status", children: [
              "● ",
              c.status
            ] })
          ] }, c.label)),
          /* @__PURE__ */ jsxs("div", { className: "scin-chart", children: [
            /* @__PURE__ */ jsx("div", { className: "scin-chart-label", children: "LATENCY (ms) — last 24h" }),
            /* @__PURE__ */ jsx(MiniChart, { vals: latencyVals, isAnomaly: false })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "scin-chart", children: [
            /* @__PURE__ */ jsx("div", { className: "scin-chart-label", children: "ANOMALY SCORE — Isolation Forest" }),
            /* @__PURE__ */ jsx(MiniChart, { vals: anomalyVals, isAnomaly: true })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "scin-log", children: mockLogs.map((l, i) => /* @__PURE__ */ jsxs("div", { className: "scin-log-line", children: [
            /* @__PURE__ */ jsxs("span", { className: "scin-log-time", children: [
              "2024-01-15 ",
              l.time
            ] }),
            /* @__PURE__ */ jsx("span", { className: l.type === "ok" ? "scin-log-ok" : l.type === "warn" ? "scin-log-warn" : "scin-log-err", children: l.label }),
    ...
    /* @__PURE__ */ jsx("div", { className: "scin-status-wrap", children: /* @__PURE__ */ jsx("div", { className: "scin-status-grid", children: statusCards.map((c) => /* @__PURE__ */ jsx(StatusTile, { card: c }, c.label)) }) }),
    online !== null && /* @__PURE__ */ jsx("div", { className: "scin-banner-wrap", children: /* @__PURE__ */ jsx("div", { className: "scin-banner-inner", children: /* @__PURE__ */ jsxs("div", { className: `scin-banner ${online ? "scin-banner-online" : "scin-banner-offline"}`, children: [
      online ? /* @__PURE__ */ jsx(Wifi, { className: "h-5 w-5", style: {
        color: "var(--green)",
        flexShrink: 0
      } }) : /* @__PURE__ */ jsx(WifiOff, { className: "h-5 w-5", style: {
        color: "var(--red)",
        flexShrink: 0
      } }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "scin-banner-title", children: online ? "Backend reachable" : "Backend belum bisa dijangkau" }),
        /* @__PURE__ */ jsx("div", { className: "scin-banner-sub", children: online ? `Connected to ${API_BASE_URL}` : `Pastikan SCINetwork API berjalan di ${API_BASE_URL}` })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsx("section", { className: "scin-segment", children: /* @__PURE__ */ jsxs("div", { className: "scin-w", children: [
      /* @__PURE__ */ jsx(SectionHead, { eyebrow: "Kemampuan Utama", title: "Semua yang dibutuhkan tim jaringan Anda", desc: "Dari inventory perangkat hingga deteksi anomali berbasis machine learning — SCINetwork dirancang untuk tim yang serius soal uptime." }),
      /* @__PURE__ */ jsx("div", { className: "scin-feat-grid", children: featureCards.map((c) => /* @__PURE__ */ jsx(FeatCard, { card: c }, c.title)) }),
      /* @__PURE__ */ jsx("div", { className: "scin-thin-bar scin-reveal scin-d1", children: thinFeats.map((f) => /* @__PURE__ */ jsxs("div", { className: "scin-thin-item", children: [
        /* @__PURE__ */ jsx("div", { className: "scin-thin-name", children: f.name }),
        /* @__PURE__ */ jsx("span", { className: "scin-thin-tag", children: f.tag })
      ] }, f.name)) }),
      /* @__PURE__ */ jsx("div", { className: "scin-stats-grid scin-reveal scin-d2", children: bigStats.map((s) => /* @__PURE__ */ jsxs("div", { className: "scin-stat", children: [
        /* @__PURE__ */ jsx("div", { className: "scin-stat-num", children: s.num }),
        /* @__PURE__ */ jsx("div", { className: "scin-stat-label", children: s.label })
      ] }, s.num)) })
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "scin-shimmer" }),
    /* @__PURE__ */ jsx("section", { className: "scin-segment", id: "technology", children: /* @__PURE__ */ jsxs("div", { className: "scin-w", children: [
      /* @__PURE__ */ jsx(SectionHead, { eyebrow: "Teknologi di dalamnya", title: "Dibangun dari monitoring real-time sampai data historis", desc: "Antarmuka, API, collector, database operasional, log time-series, dan fondasi machine learning — semuanya bekerja bersama." }),
      /* @__PURE__ */ jsx("div", { className: "scin-detail-grid", children: technologyCards.map((c, i) => /* @__PURE__ */ jsx(DetailCardUI, { card: c, delay: `scin-d${i + 1}` }, c.title)) })
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "scin-segment", style: {
      paddingTop: 0
    }, children: /* @__PURE__ */ jsxs("div", { className: "scin-w", children: [
      /* @__PURE__ */ jsx(SectionHead, { eyebrow: "Alur Data", title: "Dari probe jaringan menjadi insight", desc: "Setiap pengecekan jaringan berjalan sebagai data pipeline untuk dashboard, alert, audit, dan training model anomali." }),
      /* @__PURE__ */ jsx("div", { className: "scin-pipeline-grid", children: pipelineSteps.map((s, i) => /* @__PURE__ */ jsx(PipelineCard, { step: s, delay: `scin-d${i + 1}` }, s.title)) })
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "scin-shimmer" }),
    /* @__PURE__ */ jsx("section", { className: "scin-segment scin-ml-bg", id: "machine-learning", children: /* @__PURE__ */ jsxs("div", { className: "scin-w", children: [
      /* @__PURE__ */ jsx(SectionHead, { eyebrow: "Machine Learning", title: "Isolation Forest untuk deteksi anomali jaringan", desc: "Model ML fokus mencari pola yang jarang muncul dari log historis — timeout, lonjakan latency, packet loss, HTTP error, atau kombinasi metric tak normal." }),
      /* @__PURE__ */ jsx("div", { className: "scin-detail-grid", children: mlCards.map((c, i) => /* @__PURE__ */ jsx(DetailCardUI, { card: c, delay: `scin-d${i + 1}` }, c.title)) }),
      /* @__PURE__ */ jsx("div", { className: "scin-metric-grid", children: [{
        ...
        label: "Serving",
        val: "/score",
        desc: "FastAPI untuk inference real-time dan batch."
      }].map((m) => /* @__PURE__ */ jsxs("div", { className: "scin-metric-card scin-reveal", children: [
        /* @__PURE__ */ jsx("div", { className: "scin-metric-label", children: m.label }),
        /* @__PURE__ */ jsx("div", { className: "scin-metric-val", children: m.val }),
        /* @__PURE__ */ jsx("div", { className: "scin-metric-desc", children: m.desc })
      ] }, m.label)) })
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "scin-shimmer" }),
    /* @__PURE__ */ jsx("section", { className: "scin-segment", id: "roadmap", children: /* @__PURE__ */ jsxs("div", { className: "scin-w", children: [
      /* @__PURE__ */ jsx(SectionHead, { eyebrow: "Fitur ke depannya", title: "Roadmap ML dan observability", desc: "Alert lebih kontekstual, model lebih mudah dievaluasi, dan dashboard lebih cepat membantu admin menemukan sumber gangguan." }),
      /* @__PURE__ */ jsx("div", { className: "scin-roadmap-grid", children: roadmapItems.map((item, i) => /* @__PURE__ */ jsx(RoadmapCard, { item, delay: `scin-d${i % 3 + 1}` }, item.title)) })
    ] }) }),
    /* @__PURE__ */ jsxs("footer", { className: "scin-footer", children: [
      /* @__PURE__ */ jsxs("div", { className: "scin-footer-brand", children: [
        /* @__PURE__ */ jsx("div", { className: "scin-nav-icon", children: /* @__PURE__ */ jsx("img", { src: "/logo.png", alt: "SCINetwork logo", className: "scin-logo-img" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "scin-footer-name", children: "SCINetwork" }),
          /* @__PURE__ */ jsx("div", { className: "scin-footer-sub", children: "Go Fiber + MySQL + Isolation Forest" })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "scin-footer-copy", children: "SCINetwork v4.0 · ML-ready observability · © 2024" })
    ] })
  ] });
}
export {
